...
const Profile = () => {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      ...
      try {
        ...
        console.log('Profile data:', response.data); // Log the response to ensure the data is correct
  ...
  const handleSave = async (e) => {
    ...
    if (formData.zodiacSign) {
      data.append('zodiacSign', formData.zodiacSign); // Send zodiacSign as well if it's being updated
    }
